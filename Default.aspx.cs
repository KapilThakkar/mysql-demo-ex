...
namespace aspnet_mysql_sample
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            dvConnectionStringHeading.InnerText = "MYSQL SERVICE HOST : " + Environment.GetEnvironmentVariable("MYSQL_SERVICE_HOST");
            dvAlertError.Style.Add("display", "");
            try
            {
                //Get records from MySQL DB
                Models.SampleData.RetriveRecords();
                dvAlertError.Attributes["class"] = "alert alert-success alert-dismissible fade in";
            }
            catch (Exception ex)
            {
                dvAlertError.Attributes["class"] = "alert alert-danger alert-dismissible fade in";
