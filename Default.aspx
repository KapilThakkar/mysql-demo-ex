...
<body>
    ...
    <div class="container theme-showcase">
        <div class="jumbotron">
            <h1>MySQL Example</h1>
            <p>This is MySQL Example Application which demonstrate connectivity between ASP.NET 4.5 and MySQL on Click2Cloud Platform.</p>
        </div>
        <div class="alert alert-danger alert-dismissible fade in" role="alert" id="dvAlertError" style="display: none;" runat="server">
            ...
            <h5 id="dvConnectionStringHeading" runat="server"></h5>
            <p id="dvConnectionStringDetails" runat="server"></p>
        </div>
